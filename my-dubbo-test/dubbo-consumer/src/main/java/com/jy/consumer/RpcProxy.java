...
import com.jy.consumer.discory.DiscoryService;
import com.jy.consumer.discory.DiscoryServiceImpl;
...
public class RpcProxy {
    ...
    private static Object rpcInvoke(Class<?> tClass, Method method, Object[] args) {
        DiscoryService discoryService = new DiscoryServiceImpl();
        String serviceAddress = discoryService.discoryServer(tClass.getName());
        ...
        try {
            ...
            Integer port = Integer.valueOf(serviceAddress.split(":")[1]);
